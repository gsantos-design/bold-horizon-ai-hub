...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'tutorial.lesson_mission_desc': 'Why we serve families in Florida and New York',
  ...
  es: {
    ...
    'tutorial.lesson_mission_desc': 'Por qué servimos a familias en Florida y Nueva York',
