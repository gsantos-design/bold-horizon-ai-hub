...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'ai.campaign_launch_desc': 'Deploy AI automation for Florida and New York market targeting with personalized outreach',
  ...
  es: {
    ...
    'ai.campaign_launch_desc': 'Desplegar automatización IA para objetivo de mercado de Florida y Nueva York con alcance personalizado',
