            ...
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardHeader className="text-center pb-6">
                ...
                <p className="text-gray-600 mt-2">
                  Your personal career guide powered by the Santiago Team's expertise
                </p>
              </CardHeader>
              <CardContent>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mt-2">
              Powered by Santiago Team expertise • Emotional Intelligence enabled
            </p>
          </motion.div>
            ...
            <div className="p-6 border-t">
              <form onSubmit={handleSendMessage} className="flex space-x-3">
                <Textarea
                  ...
                  placeholder="Ask about your career path, WFG opportunities, or any questions..."
